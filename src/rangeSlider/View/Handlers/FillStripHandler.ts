...
class FillStripHandler {
  ...
  addEvent = (DOMFillStrip: HTMLDivElement) => {
    DOMFillStrip.addEventListener("click", this.handleMouseClick);
    DOMFillStrip.addEventListener("touchstart", this.handleMouseClick);
  };

  removeEvent = (DOMFillStrip: HTMLDivElement) => {
    DOMFillStrip.removeEventListener("click", this.handleMouseClick);
    DOMFillStrip.removeEventListener("touchstart", this.handleMouseClick);
  };
...
export default FillStripHandler;
